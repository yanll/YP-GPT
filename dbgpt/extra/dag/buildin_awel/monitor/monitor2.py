...
class Monitor2(AirlineMonitorDataHandler):
    ...
    def deal_payer_customer(self, payer_sales_name, payer_customer):
        try:
            ...
            d_1_data = \
                self.monitor2_data.get_data_by_payer_in_monitor2(trx_date=self.d_1_date,
                                                                 payer_sales_name=payer_sales_name,
    ...
    def deal_customer(self, sales_name, customer):
        try:
            ...
            d_1_data = self.monitor2_data.get_data_by_stat_in_monitor2(trx_date=self.d_1_date, sales_name=sales_name,
